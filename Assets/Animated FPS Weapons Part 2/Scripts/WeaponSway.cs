...
public class WeaponSway : MonoBehaviour
{
    ...
    public Vector2 GetSwayOffset()
    {
        return new Vector2(targetRotation.z, targetRotation.x);
    }
    ...
    private void Update()
    {
        ...
        FinalPosition = new Vector3(def.x + factorX, def.y + factorY, def.z);
        ...
        targetRotation = Quaternion.Euler(tiltAroundX, 0, tiltAroundZ);
